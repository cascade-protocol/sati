/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 83f154f84b2a1603d065110e3d314e40)
// Runtime types generated with workerd@1.20251213.0 2025-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
	}
	interface Env {
		TURBO_SOLANA_PRIVATE_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURBO_SOLANA_PRIVATE_KEY">> {}
}
